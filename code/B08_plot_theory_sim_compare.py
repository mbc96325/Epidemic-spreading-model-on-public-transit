...
def plot_I_compare_scatter(data_thry_I , data_sim_I, save_fig):
    ...
    if save_fig == 1:
        plt.savefig('img/compare_theory_sim_I_scatter.eps', dpi = 200)
    else:
        plt.show()
...
def plot_E_compare_scatter(data_thry_I , data_sim_I, save_fig):
    ...
    if save_fig == 1:
        plt.savefig('img/compare_theory_sim_E_scatter.eps', dpi = 200)
    else:
        plt.show()
...
def plot_E_compare_time_varying(data_thry_E , data_sim_E, case_used, save_fig):
    ...
    plt.tight_layout()
    if save_fig == 1:
        plt.savefig('img/compare_theory_sim_E_time_varying.eps', dpi=200)
    else:
        plt.show()
...
def plot_I_compare_time_varying(data_thry_I , data_sim_I,case_used, save_fig):
    ...
    plt.tight_layout()
    if save_fig == 1:
        plt.savefig('img/compare_theory_sim_I_time_varying.eps', dpi=200)
    else:
        plt.show()
    return case_used
...
if __name__ == '__main__':
    ...
    plot_I_compare_scatter(data_thry_I, data_sim_I, save_fig = 1)
    plot_E_compare_scatter(data_thry_E, data_sim_E, save_fig = 1)
