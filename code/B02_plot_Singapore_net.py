...
def plot_demand_distribution(data, time_interval, save_fig):
    ...
    plt.tight_layout()
    if save_fig == 1:
        plt.savefig('img/demand_distribution.eps', dpi = 200)
    else:
        plt.show()
    #plt.close()
...
def plot_trip_duration(data, save_fig):
    ...
    if save_fig == 1:
        plt.savefig('img/trip_duration_distribution.eps', dpi = 200)
    else:
        plt.show()
...
def plot_trip_frequency(data, save_fig):
    ...
    if save_fig == 1:
        plt.savefig('img/trip_frequency_distribution.eps', dpi = 200)
    else:
        plt.show()
